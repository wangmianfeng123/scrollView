...
NSString *getCATransitionTypeStringWithCATransitionType(CATransitionTypeo type) {
    switch (type) {
...
- (void)pushViewController:(UIViewController *)viewController withCATransitionType:(CATransitionTypeo)type subType:(CATransitionSubType)subType animated:(BOOL)animated
{
...
- (void)popViewControllerWithCATransitionType:(CATransitionTypeo)type subType:(CATransitionSubType)subType animated:(BOOL)animated
{
    NSString *typeString = getCATransitionTypeStringWithCATransitionType(type);
    NSString *subTypeString = getCATransitionSubType(subType);

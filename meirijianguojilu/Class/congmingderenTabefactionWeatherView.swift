...
class congmingderenTabefactionWeatherView: UIView,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    let weatherArray = ["wuwenxidonggequ","dachshundDuoyun","numericalQreleiyingkuang","forwardXiaoyu","kabulZhongyu","solityfinddac","taiyangshegnqilai","threadXiaoxue","generikaixin","nablusDaxue","xingzhuanacce"]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.importImage.image = UIImage.init(named: self.weatherArray[indexPath.row])
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let image = UIImage.init(named: self.weatherArray[indexPath.item])
        self.qbpBlock(image!)

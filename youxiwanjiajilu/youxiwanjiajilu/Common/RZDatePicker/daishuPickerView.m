...
@interface daishuPickerView()<UIPickerViewDelegate,UIPickerViewDataSource,UIGestureRecognizerDelegate>{
    //日期存储数组
...
@implementation daishuPickerView
...
-(void)addLabelWithName:(NSArray *)nameArr {
    ...
    for (int i=0; i<nameArr.count; i++) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(labelX, self.showYearView.frame.size.height/2-7.5, 40, 15)];
...
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView *)pickerView
{
    switch (self.datePickerStyle) {
        case DateStyleShowYearMonthDayHourMinute:
           // [self addLabelWithName:@[@"year",@"month",@"day",@"hour",@"minute"]];
            return 5;
        case DateStyleShowYearMonthDay:
          //  [self addLabelWithName:@[@"year",@"month",@"day"]];
            return 3;
        case DateStyleShowMonthDayHourMinute:
          //  [self addLabelWithName:@[@"month",@"day",@"hour",@"minute"]];
            return 4;
        case DateStyleShowMonthDay:
          //  [self addLabelWithName:@[@"month",@"day"]];
            return 2;
        case DateStyleShowHourMinute:
          //  [self addLabelWithName:@[@"hour",@"minute"]];
            return 2;
        default:
            return 0;
    }
...
- (void)setDatePickerStyle:(RZDateStyle)datePickerStyle {
